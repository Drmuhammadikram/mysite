...
sections:
  ...
  - block: markdown
    content:
      title: '2 · Ecological footprint and biocapacity worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '3 · SDG Index: progress toward the Goals'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '5 · Literacy and education'
      subtitle: ''
      text: |-
        Adult, female and youth literacy, secondary and tertiary enrolment, and public spending on education across 187 countries. Literacy is measured by census rather than annually, so those views show each country's most recent reading with the year on hover — Morocco's is from 2014. Rich countries stop reporting literacy once it nears universal, which is why they appear blank rather than at 100%.

        {{< education >}}

        [Full page: why literacy has no year buttons →](/data/education/)
    design:
      columns: '1'
      spacing:
        padding: ['1rem', '0', '1rem', '0']
  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        [Full page: the number that reframes the others →](/data/food-security/)
    design:
      columns: '1'
      spacing:
        padding: ['1rem', '0', '1rem', '0']
  ...
  - block: markdown
    content:
      title: '10 · Natural resource rents'
      subtitle: ''
      text: |-
        ...
        [Full page: what a rent is, and the resource curse →](/data/resource-rents/)
    design:
      columns: '1'
      spacing:
        padding: ['1rem', '0', '1rem', '0']
  - block: markdown
    content:
      title: '11 · Governance indicators'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '12 · Deaths in armed conflicts'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '13 · Homicide and imprisonment'
      subtitle: ''
      text: |-
        ...
        [Full page: why there is no crime rate here →](/data/homicide/)
    design:
      columns: '1'
      spacing:
        padding: ['1rem', '0', '1rem', '0']
  - block: markdown
    content:
      title: '14 · Internet access worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '15 · Population and demography'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      ...
      text: |-
        ...
        [Full page: why the gap rather than the rate →](/data/women-employment/)
    design:
      columns: '1'
      spacing:
        padding: ['1rem', '0', '1rem', '0']
  - block: markdown
    content:
      title: '17 · ISO management system certifications worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '18 · Coal consumption worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '21 · Electric vehicle adoption'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '22 · Water stress worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '23 · Water use and resources'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '24 · Air quality worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '25 · Forests and deforestation'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '26 · Food waste per capita'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '27 · Natural disasters worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '28 · Life satisfaction worldwide'
      subtitle: ''
      text: |-
  ...
  - block: markdown
    content:
      title: '29 · Research output by country'
      subtitle: ''
      text: |-
